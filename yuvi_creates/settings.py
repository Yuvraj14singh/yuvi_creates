...
WSGI_APPLICATION = "yuvi_creates.wsgi.application"
...
CSRF_TRUSTED_ORIGINS = [
    "https://yuvicreates-production.up.railway.app",
]
...
RAZORPAY_KEY_SECRET = os.environ.get("RAZORPAY_KEY_SECRET") or os.environ.get("RAZORPAY_TEST_KEY_SECRET", "")
